                        ...
                        <div class="row g-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="logos_insignias" id="logos_insignias" class="form-control"
                                    value="{{ old('logos_insignias', $producto->logos_insignias ?? '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="forro" id="forro" class="form-control"
                                    value="{{ old('forro', $producto->forro ?? '') }}">
                                    @error('forro')
                                <small class="text-danger">{{ '*' . $message }}</small>
                            @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="material_tela" id="material_tela" class="form-control"
                                    value="{{ old('material_tela', $producto->material_tela ?? '') }}">
                                    @error('material_tela')
                                <small class="text-danger">{{ '*' . $message }}</small>
                            @enderror
                            </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select data-size="4" multiple title="Seleccione los materiales" data-live-search="true"
                            ...
                            @foreach ($materiales as $item)
                                @if (in_array($item->id, $producto->materiale->pluck('id')->toArray()))
                                    <option selected value="{{ $item->id }}"
                                        {{ in_array($item->id, old('materiales', [])) ? 'selected' : '' }}>
                                        {{ $item->nombre }}</option>
                                @else
